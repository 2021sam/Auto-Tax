...
def print_df_structure(df):
    ...
    # Example to print the entire DataFrame
    pd.set_option('display.max_rows', None)  # Remove the row limit
    pd.set_option('display.max_columns', None)  # Remove the column limit
    pd.set_option('display.width', None)  # Ensure the columns are not truncated
...
if __name__ == "__main__":
    ...
    print_df_structure(mapped_transactions)
    # exit()
