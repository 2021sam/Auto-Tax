...
def map(file_coa):
    ...
    try:
        ...
        print(f"Error mapping with COA file {file_coa}: {e}")
...
if __name__ == "__main__":
    ...
    # Check if 'chase_df' is loaded before proceeding
    if chase_df is not None:
        join(file_coa)
    else:
        print("Transaction data not loaded. Exiting...")
